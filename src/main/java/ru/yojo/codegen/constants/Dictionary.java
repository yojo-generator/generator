...
public final class Dictionary {
    /**
     * Standard AsyncAPI YAML attribute names.
     */
    /**
     ...
     */
    public static final Map<String, String> JAVA_TYPES_REQUIRED_ANNOTATIONS = Map.ofEntries(
            Map.entry(STRING, NOT_BLANK_ANNOTATION),
            Map.entry(BYTE, NOT_NULL_ANNOTATION),
            Map.entry(INTEGER, NOT_NULL_ANNOTATION),
            Map.entry(LONG, NOT_NULL_ANNOTATION),
            Map.entry(DOUBLE, NOT_NULL_ANNOTATION),
            Map.entry(FLOAT, NOT_NULL_ANNOTATION),
            Map.entry(BOOLEAN, NOT_NULL_ANNOTATION),
            Map.entry(LOCAL_DATE, NOT_NULL_ANNOTATION),
            Map.entry(LOCAL_DATE_TIME, NOT_NULL_ANNOTATION),
            Map.entry(SIMPLE_DATE, NOT_NULL_ANNOTATION),
            Map.entry(BIG_DECIMAL, NOT_NULL_ANNOTATION),
            Map.entry(BIG_INTEGER, NOT_NULL_ANNOTATION),
            Map.entry(UUID, NOT_NULL_ANNOTATION),
            Map.entry(OBJECT_TYPE, NOT_NULL_ANNOTATION)
    );

    /**
     * Maps annotation names to javax.validation import declarations.
     */
    public static final Map<String, String> JAVAX_JAVA_TYPES_REQUIRED_IMPORTS = Map.ofEntries(
            Map.entry(NOT_BLANK_ANNOTATION, JAVAX_NOT_BLANK_IMPORT),
            Map.entry(NOT_EMPTY_ANNOTATION, JAVAX_NOT_EMPTY_IMPORT),
     ...
     */
    public static final Map<String, String> JAKARTA_JAVA_TYPES_REQUIRED_IMPORTS = Map.ofEntries(
            Map.entry(NOT_BLANK_ANNOTATION, JAKARTA_NOT_BLANK_IMPORT),
            Map.entry(NOT_EMPTY_ANNOTATION, JAKARTA_NOT_EMPTY_IMPORT),
     ...
     */
    public static final Map<String, Object> JAVA_LOWER_CASE_TYPES_CHECK_CONVERTER = Map.ofEntries(
            Map.entry(ST_STRING, STRING),
            Map.entry(ST_BYTE, BYTE),
            Map.entry(ST_INTEGER, INTEGER),
            Map.entry(ST_LONG, LONG),
            Map.entry(ST_DOUBLE, DOUBLE),
            Map.entry(ST_FLOAT, FLOAT),
            Map.entry(ST_BOOLEAN, BOOLEAN),
            Map.entry(ST_BIG_DECIMAL, BIG_DECIMAL),
            Map.entry(ST_BIG_INTEGER, BIG_INTEGER),
            Map.entry(ST_LOCAL_DATE, LOCAL_DATE),
            Map.entry(ST_LOCAL_DATE_TIME, LOCAL_DATE_TIME),
     ...
     */
    public static final Map<String, Object> JAVA_UPPER_CASE_TYPES_CHECK_CONVERTER = Map.ofEntries(
            Map.entry(STRING, ST_STRING),
            Map.entry(BYTE, ST_BYTE),
            Map.entry(INTEGER, ST_INTEGER),
            Map.entry(LONG, ST_LONG),
            Map.entry(DOUBLE, ST_DOUBLE),
            Map.entry(FLOAT, ST_FLOAT),
            Map.entry(BOOLEAN, ST_BOOLEAN),
            Map.entry(BIG_DECIMAL, ST_BIG_DECIMAL),
            Map.entry(BIG_INTEGER, ST_BIG_INTEGER),
            Map.entry(LOCAL_DATE, ST_LOCAL_DATE),
            Map.entry(LOCAL_DATE_TIME, ST_LOCAL_DATE_TIME),
            Map.entry(SIMPLE_DATE, ST_SIMPLE_DATE),
            Map.entry(UUID, ST_UUID),
            Map.entry(URI, ST_URI)
    );
}