...
/**
 * Test enum-values.yaml contract without Lombok.
 ...
 * </ul>
 */
public class EnumValuesWithoutLombokTest extends GenerationComparisonTestBase {
    ...
    @Test
    void testEnumValuesWithoutLombok() throws IOException {
        generateAndCompare();
    }
}
